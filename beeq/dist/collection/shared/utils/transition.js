 ...
 */
export const enter = async (element, transitionName = null) => {
 ...
 * @returns A promise that resolves when the transition is complete
 */
export const leave = async (element, transitionName = null) => {
 ...
 * @returns A promise that resolves when the transition is complete
 */
export const toggle = async (element, transitionName = null) => {
