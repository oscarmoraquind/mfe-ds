...
import { m as isNil, n as isString, g as getBasePath, a as getColorCSSVariable } from './index3.js';
...
const BqIcon = /*@__PURE__*/ proxyCustomElement(class BqIcon extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqIconCss; }
}, [1, "bq-icon", {
        "label": [513],
        "color": [513],
        "name": [513],
...
function defineCustomElement() {
    ...
    const components = ["bq-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqIcon);
            }
            break;
    } });
}

export { BqIcon as B, defineCustomElement as d };

//# sourceMappingURL=bq-icon2.js.map