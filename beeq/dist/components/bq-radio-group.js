...
import { m as isNil, v as validatePropValue, d as debounce, l as isHTMLElement } from './index3.js';
...
const BqRadioGroup$1 = /*@__PURE__*/ proxyCustomElement(class BqRadioGroup extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqRadioGroupCss; }
}, [81, "bq-radio-group", {
        ...
        "value": [1537]
    }, [[17, "mousedown", "onMouseDown"], [0, "bqClick", "onBqClick"], [0, "bqKeyDown", "onBqKeyDown"], [2, "bqFocus", "onBqFocus"], [2, "bqBlur", "onBqBlur"]], {
        "backgroundOnHover": ["handleGroupProperties"],
        "disabled": ["handleGroupProperties"],
        "name": ["handleGroupProperties"],
        "required": ["handleGroupProperties", "handleRequiredChange"],
...
function defineCustomElement$1() {
    ...
    const components = ["bq-radio-group"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-radio-group":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqRadioGroup$1);
            }
            break;
    } });
}

const BqRadioGroup = BqRadioGroup$1;
const defineCustomElement = defineCustomElement$1;

export { BqRadioGroup, defineCustomElement };
