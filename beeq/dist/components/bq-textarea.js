...
import { l as isHTMLElement, d as debounce, t as hasSlotContent, m as isNil } from './index3.js';
...
const BqTextarea$1 = /*@__PURE__*/ proxyCustomElement(class BqTextarea extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqTextareaCss; }
}, [81, "bq-textarea", {
        "autocapitalize": [513],
        "autocomplete": [513],
        "autocorrect": [513],
...
function defineCustomElement$1() {
    ...
    const components = ["bq-textarea"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqTextarea$1);
            }
            break;
    } });
}

const BqTextarea = BqTextarea$1;
const defineCustomElement = defineCustomElement$1;

export { BqTextarea, defineCustomElement };
