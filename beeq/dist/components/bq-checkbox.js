...
import { m as isNil } from './index3.js';
...
const BqCheckbox$1 = /*@__PURE__*/ proxyCustomElement(class BqCheckbox extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqCheckboxCss; }
}, [81, "bq-checkbox", {
...
function defineCustomElement$1() {
    ...
    const components = ["bq-checkbox"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-checkbox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqCheckbox$1);
            }
            break;
    } });
}

const BqCheckbox = BqCheckbox$1;
const defineCustomElement = defineCustomElement$1;

export { BqCheckbox, defineCustomElement };
