...
import { v as validatePropValue, t as hasSlotContent, a as getColorCSSVariable } from './index3.js';
import { d as defineCustomElement$2 } from './bq-button2.js';
import { d as defineCustomElement$1 } from './bq-icon2.js';
...
const BqTag = /*@__PURE__*/ proxyCustomElement(class BqTag extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqTagCss; }
}, [17, "bq-tag", {
        "border": [513],
        "clickable": [516],
        "color": [513],
...
function defineCustomElement() {
    ...
    const components = ["bq-tag", "bq-button", "bq-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-tag":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqTag);
            }
            break;
        case "bq-button":
            if (!customElements.get(tagName)) {
...
export { BqTag as B, defineCustomElement as d };

//# sourceMappingURL=bq-tag2.js.map