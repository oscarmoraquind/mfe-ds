...
import { n as isString, m as isNil, l as isHTMLElement, j as isDefined, d as debounce, t as hasSlotContent } from './index3.js';
...
const BqSelect$1 = /*@__PURE__*/ proxyCustomElement(class BqSelect extends H {
    ...
    static get style() { return bqSelectCss; }
}, [81, "bq-select", {
        "autofocus": [516],
        ...
        "hasValue": [32],
        "clear": [64]
    }, [[2, "bqOpen", "handleOpenChange"], [2, "bqFocus", "stopOptionFocusBlurPropagation"], [2, "bqBlur", "stopOptionFocusBlurPropagation"]], {
        "value": ["handleValueChange"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["bq-select", "bq-button", "bq-dropdown", "bq-icon", "bq-option-list", "bq-panel", "bq-tag"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-select":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqSelect$1);
            }
            break;
        case "bq-button":
            if (!customElements.get(tagName)) {
...
const BqSelect = BqSelect$1;
const defineCustomElement = defineCustomElement$1;

export { BqSelect, defineCustomElement };
