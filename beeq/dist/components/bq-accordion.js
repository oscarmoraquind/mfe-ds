...
import { v as validatePropValue, t as hasSlotContent } from './index3.js';
...
const BqAccordion$1 = /*@__PURE__*/ proxyCustomElement(class BqAccordion extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqAccordionCss; }
}, [1, "bq-accordion", {
        "appearance": [1537],
        "disabled": [516],
        "expanded": [1540],
        ...
        "hasPrefix": [32],
        "hasSuffix": [32]
    }, [[0, "accordionTransitionEnd", "onAccordionTransitionEnd"]], {
        "size": ["checkPropValues"],
        "expanded": ["handleExpandedChange"],
        "disabled": ["handleDisabledChange"],
        "noAnimation": ["handleJsAnimation"]
...
function defineCustomElement$1() {
    ...
    const components = ["bq-accordion", "bq-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-accordion":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqAccordion$1);
            }
            break;
        case "bq-icon":
            if (!customElements.get(tagName)) {
...
const BqAccordion = BqAccordion$1;
const defineCustomElement = defineCustomElement$1;

export { BqAccordion, defineCustomElement };
