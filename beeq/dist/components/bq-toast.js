...
import { h as isClient, v as validatePropValue, d as debounce } from './index3.js';
...
const TOAST_BORDER_RADIUS = ['none', 'xs2', 'xs', 's', 'm', 'l', 'full'];
...
const BqToast$1 = /*@__PURE__*/ proxyCustomElement(class BqToast extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqToastCss; }
}, [1, "bq-toast", {
        "border": [513],
        "type": [1537],
        "placement": [1537],
...
function defineCustomElement$1() {
    ...
    const components = ["bq-toast", "bq-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-toast":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqToast$1);
            }
            break;
        case "bq-icon":
            if (!customElements.get(tagName)) {
...
const BqToast = BqToast$1;
const defineCustomElement = defineCustomElement$1;

export { BqToast, defineCustomElement };
