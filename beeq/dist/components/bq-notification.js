...
import { h as isClient, d as debounce, v as validatePropValue, w as leave, u as enter, t as hasSlotContent } from './index3.js';
...
const NOTIFICATION_BORDER_RADIUS = ['none', 'xs2', 'xs', 's', 'm', 'l', 'full'];
...
const BqNotification$1 = /*@__PURE__*/ proxyCustomElement(class BqNotification extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqNotificationCss; }
}, [1, "bq-notification", {
