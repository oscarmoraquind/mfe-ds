...
import { v as validatePropValue, w as leave, u as enter, t as hasSlotContent } from './index3.js';
...
const DIALOG_BORDER_RADIUS = ['none', 'xs2', 'xs', 's', 'm', 'l', 'full'];
...
const BqDialog$1 = /*@__PURE__*/ proxyCustomElement(class BqDialog extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqDialogCss; }
}, [1, "bq-dialog", {
        "border": [513],
...
function defineCustomElement$1() {
    ...
    const components = ["bq-dialog", "bq-button", "bq-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-dialog":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqDialog$1);
            }
            break;
        case "bq-button":
            if (!customElements.get(tagName)) {
...
const BqDialog = BqDialog$1;
const defineCustomElement = defineCustomElement$1;

export { BqDialog, defineCustomElement };
