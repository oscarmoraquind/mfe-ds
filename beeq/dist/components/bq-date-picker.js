...
import { m as isNil, j as isDefined, v as validatePropValue, h as isClient, i as isEventTargetChildOfElement, l as isHTMLElement, t as hasSlotContent } from './index3.js';
import { d as defineCustomElement$5 } from './bq-button2.js';
import { d as defineCustomElement$4 } from './bq-dropdown2.js';
import { d as defineCustomElement$3 } from './bq-icon2.js';
import { d as defineCustomElement$2 } from './bq-panel2.js';
...
const BqDatePicker$1 = /*@__PURE__*/ proxyCustomElement(class BqDatePicker extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return bqDatePickerCss; }
}, [81, "bq-date-picker", {
        "autofocus": [516],
...
function defineCustomElement$1() {
    ...
    const components = ["bq-date-picker", "bq-button", "bq-dropdown", "bq-icon", "bq-panel"];
    components.forEach(tagName => { switch (tagName) {
        case "bq-date-picker":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BqDatePicker$1);
            }
            break;
        case "bq-button":
            if (!customElements.get(tagName)) {
...
const BqDatePicker = BqDatePicker$1;
const defineCustomElement = defineCustomElement$1;

export { BqDatePicker, defineCustomElement };
