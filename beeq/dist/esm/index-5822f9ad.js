...
const BUILD = /* beeq */ { allRenderFn: true, appendChildSlotFix: true, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: true, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: true, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: true, constructableCSS: true, cssAnnotations: true, devTools: true, disconnectedCallback: true, element: false, event: true, experimentalScopedSlotChanges: true, experimentalSlotFixes: true, formAssociated: true, hasRenderFn: true, hostListener: true, hostListenerTarget: true, hostListenerTargetBody: true, hostListenerTargetDocument: true, hostListenerTargetParent: false, hostListenerTargetWindow: true, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, hydratedSelectorName: "hydrated", initializeNextTick: false, invisiblePrehydration: true, isDebug: false, isDev: true, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, modernPropertyDecls: true, observeAttribute: true, profile: true, prop: true, propBoolean: true, propMutable: true, propNumber: true, propString: true, reflect: true, scoped: false, scopedSlotTextContentFix: true, scriptDataOpts: false, shadowDelegatesFocus: true, shadowDom: true, slot: true, slotChildNodesFix: true, slotRelocation: false, state: true, style: true, svg: true, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: true, watchCallback: true };
const Env = /* beeq */ {};
...
var reWireGetterSetter = (instance, hostRef) => {
  ...
  members.map(([memberName, [memberFlags]]) => {
    if (BUILD.state && BUILD.prop && (memberFlags & 2048 /* Getter */) === 0 && (memberFlags & 31 /* Prop */ || memberFlags & 32 /* State */)) {
        ...
        if (!hmrVersionId || !BUILD.hotModuleReplacement) {
          ...
          switch(bundleId) {
                ...
                case 'bq-accordion':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-accordion.entry.js').then(processMod, consoleError);
                case 'bq-accordion-group':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-accordion-group.entry.js').then(processMod, consoleError);
                case 'bq-alert':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-alert.entry.js').then(processMod, consoleError);
                case 'bq-avatar':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-avatar.entry.js').then(processMod, consoleError);
                case 'bq-breadcrumb':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-breadcrumb.entry.js').then(processMod, consoleError);
                case 'bq-breadcrumb-item':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-breadcrumb-item.entry.js').then(processMod, consoleError);
                case 'bq-card':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-card.entry.js').then(processMod, consoleError);
                case 'bq-checkbox':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-checkbox.entry.js').then(processMod, consoleError);
                case 'bq-col':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-col.entry.js').then(processMod, consoleError);
                case 'bq-date-picker':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-date-picker.entry.js').then(processMod, consoleError);
                case 'bq-dialog':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-dialog.entry.js').then(processMod, consoleError);
                case 'bq-drawer':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-drawer.entry.js').then(processMod, consoleError);
                case 'bq-empty-state':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-empty-state.entry.js').then(processMod, consoleError);
                case 'bq-grid':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-grid.entry.js').then(processMod, consoleError);
                case 'bq-input':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-input.entry.js').then(processMod, consoleError);
                case 'bq-logo':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-logo.entry.js').then(processMod, consoleError);
                case 'bq-notification':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-notification.entry.js').then(processMod, consoleError);
                case 'bq-option':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-option.entry.js').then(processMod, consoleError);
                case 'bq-option-group':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-option-group.entry.js').then(processMod, consoleError);
                case 'bq-page-title':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-page-title.entry.js').then(processMod, consoleError);
                case 'bq-progress':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-progress.entry.js').then(processMod, consoleError);
                case 'bq-radio':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-radio.entry.js').then(processMod, consoleError);
                case 'bq-radio-group':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-radio-group.entry.js').then(processMod, consoleError);
                case 'bq-row':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-row.entry.js').then(processMod, consoleError);
                case 'bq-select':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-select.entry.js').then(processMod, consoleError);
                case 'bq-side-menu':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-side-menu.entry.js').then(processMod, consoleError);
                case 'bq-side-menu-item':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-side-menu-item.entry.js').then(processMod, consoleError);
                case 'bq-slider':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-slider.entry.js').then(processMod, consoleError);
                case 'bq-spinner':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-spinner.entry.js').then(processMod, consoleError);
                case 'bq-status':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-status.entry.js').then(processMod, consoleError);
                case 'bq-step-item':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-step-item.entry.js').then(processMod, consoleError);
                case 'bq-steps':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-steps.entry.js').then(processMod, consoleError);
                case 'bq-switch':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-switch.entry.js').then(processMod, consoleError);
                case 'bq-tab':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-tab.entry.js').then(processMod, consoleError);
                case 'bq-tab-group':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-tab-group.entry.js').then(processMod, consoleError);
                case 'bq-text':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-text.entry.js').then(processMod, consoleError);
                case 'bq-textarea':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-textarea.entry.js').then(processMod, consoleError);
                case 'bq-toast':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-toast.entry.js').then(processMod, consoleError);
                case 'bq-badge':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-badge.entry.js').then(processMod, consoleError);
                case 'bq-option-list':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-option-list.entry.js').then(processMod, consoleError);
                case 'bq-tag':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-tag.entry.js').then(processMod, consoleError);
                case 'bq-divider':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-divider.entry.js').then(processMod, consoleError);
                case 'bq-dropdown':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-dropdown.entry.js').then(processMod, consoleError);
                case 'bq-panel':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-panel.entry.js').then(processMod, consoleError);
                case 'bq-tooltip':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-tooltip.entry.js').then(processMod, consoleError);
                case 'bq-button':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-button.entry.js').then(processMod, consoleError);
                case 'bq-icon':
                    return import(
                      /* webpackMode: "lazy" */
                      './bq-icon.entry.js').then(processMod, consoleError);
          }
      }
  return import(
    /* @vite-ignore */
    ...
    if (BUILD.style && Cstr && Cstr.style) {
      ...
      if (!styles.has(scopeId2)) {
        ...
        BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
          style = await import('./shadow-css-2d1f8756.js').then((m) => m.scopeCss(style, scopeId2));
        }
...
export { BUILD as B, Env as E, Fragment as F, H, NAMESPACE as N, createEvent as a, bootstrapLazy as b, consoleDevInfo as c, doc as d, Host as e, getElement as g, h, promiseResolve as p, registerInstance as r, setNonce as s };

//# sourceMappingURL=index-5822f9ad.js.map