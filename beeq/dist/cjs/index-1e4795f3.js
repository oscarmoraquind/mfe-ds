    ...
    return module[exportName];
        ...
        if (!hmrVersionId || !BUILD.hotModuleReplacement) {
          ...
          switch(bundleId) {
                ...
                case 'bq-option-list.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './bq-option-list.cjs.entry.js')); }).then(processMod, consoleError);
                case 'bq-tag.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './bq-tag.cjs.entry.js')); }).then(processMod, consoleError);
                case 'bq-divider.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './bq-divider.cjs.entry.js')); }).then(processMod, consoleError);
                case 'bq-dropdown.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './bq-dropdown.cjs.entry.js')); }).then(processMod, consoleError);
                case 'bq-panel.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './bq-panel.cjs.entry.js')); }).then(processMod, consoleError);
                case 'bq-tooltip.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
    ...
    if (BUILD.style && Cstr && Cstr.style) {
      ...
      if (!styles.has(scopeId2)) {
        ...
        BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
          style = await Promise.resolve().then(function () { return require('./shadow-css-0987932f.js'); }).then((m) => m.scopeCss(style, scopeId2));
        }
...
//# sourceMappingURL=index-1e4795f3.js.map