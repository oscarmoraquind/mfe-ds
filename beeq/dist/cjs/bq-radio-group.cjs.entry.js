...
const BqRadioGroup = class {
    ...
    handleGroupProperties() {
        ...
        this.bqRadioElements.forEach((bqRadio) => {
            ...
            bqRadio.checked = !index$1.isNil(this.value) ? bqRadio.value === this.value : false;
    ...
    checkPropValues() {
        index$1.validatePropValue(RADIO_GROUP_ORIENTATION, 'vertical', this.el, 'orientation');
    }
    checkDebounceChange() {
        ...
        this.debouncedBqChange = index$1.debounce((event) => {
    ...
    // ==============
    onMouseDown(event) {
        if (!index$1.isNil(this.focusedBqRadio) && index$1.isHTMLElement(event.target, 'bq-radio') && this.el.contains(event.target)) {
            this.focusedBqRadio = event.target;
        }
    }
    onBqClick(event) {
        if (index$1.isNil(this.focusedBqRadio)) {
    ...
    onBqKeyDown(event) {
        const { target } = event;
        if (!index$1.isHTMLElement(target, 'bq-radio'))
            return;
    ...
    onBqBlur(event) {
        if (!index$1.isNil(this.focusedBqRadio) && event.detail !== this.focusedBqRadio) {
            event.stopPropagation();
        }
        else {
    ...
    updateFormValidity = async () => {
        ...
        if (!required || (required && !index$1.isNil(value))) {
    ...
    // ===================================
    render() {
        return (index.h("fieldset", { key: 'c8255d626f81c91d47eadc332661e32409508a22', class: { 'bq-radio-group': true, 'has-fieldset': this.fieldset }, "aria-labelledby": "bq-radio-group__label", "aria-controls": "bq-radiogroup", role: "radiogroup", part: "base" }, index.h("legend", { key: '792efa8bca0a69d94a1e7df37df97d18099a711e', part: "label" }, index.h("slot", { key: '7aa7e29c428533ce1e828595bd079df273653e38', id: "bq-radiogroup__label", name: "label" })), index.h("div", { key: '8077721556603ae355a9d78111673a098be160f5', class: `bq-radio-group--${this.orientation}`, part: "group" }, index.h("slot", { key: '6ee4498e1a97666df11d09e35fada6f2dce2ca16', id: "bq-radiogroup" }))));
    }
...
exports.bq_radio_group = BqRadioGroup;

//# sourceMappingURL=bq-radio-group.cjs.entry.js.map