...
const BqInput = class {
    ...
    handleInput = (ev) => {
        ...
        this.debounceBqInput = index$1.debounce(() => {
    ...
    setFormValue = (value) => {
        this.internals.setFormValue(!index$1.isNil(value) ? `${value}` : undefined);
    };
    updateFormValidity = () => {
    ...
    handleHelperTextSlotChange = () => {
        this.hasHelperText = index$1.hasSlotContent(this.helperTextElem);
    };
    // render() function
