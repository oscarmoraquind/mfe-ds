...
const BqInputStyle0 = bqInputCss;
...
const BqInput = class {
    constructor(hostRef) {
        ...
        this.bqInput = index.createEvent(this, "bqInput", 7);
    ...
    handleValueChange() {
        ...
        this.hasValue = isDefined.isDefined(value);
    ...
    handleInput = (ev) => {
        ...
        if (!isHTMLElement.isHTMLElement(ev.target, 'input'))
            return;
        this.value = this.type === 'number' ? Number(ev.target.value) : ev.target.value;
        this.debounceBqInput = debounce.debounce(() => {
    ...
    setFormValue = (value) => {
        this.internals.setFormValue(!isNil.isNil(value) ? `${value}` : undefined);
    };
    updateFormValidity = () => {
    ...
    // ===================================
    render() {
        return (index.h("div", { key: '0dcdf81922be21d38f7bba929c9b27abfcf71c49', class: "bq-input", part: "base" }, index.h("label", { key: '8e2f0c455008a207c18eb0d8ca6ce2efa52f1690', class: { 'bq-input--label': true, '!hidden': !this.hasLabel }, "aria-label": this.name || this.fallbackInputId, htmlFor: this.name || this.fallbackInputId, ref: (labelElem) => (this.labelElem = labelElem), part: "label" }, index.h("slot", { key: '933f0cb7688021ca2d045d29ea27b98f4faf4ad2', name: "label", onSlotchange: this.handleLabelSlotChange })), index.h("div", { key: '2021e802923da53378fa842638c865764a19b4dd', class: {
                'bq-input--control': true,
                [`validation-${this.validationStatus}`]: true,
                disabled: this.disabled,
            }, part: "control" }, index.h("span", { key: '767338a2a5befd7eed4838cc59141bc157e2cab2', class: { 'bq-input--control__prefix': true, '!hidden': !this.hasPrefix }, ref: (spanElem) => (this.prefixElem = spanElem), part: "prefix" }, index.h("slot", { key: 'b4a6167db257e470ce459f2e7384d6dbfce5c469', name: "prefix", onSlotchange: this.handlePrefixSlotChange })), index.h("input", { key: 'eed7a59ddf917f8ab056a7107db1e28ba5592190', id: this.name || this.fallbackInputId, class: "bq-input--control__input", "aria-disabled": this.disabled ? 'true' : 'false', autoCapitalize: this.autocapitalize, autoComplete: this.autocomplete, autoCorrect: this.autocorrect, disabled: this.disabled, form: this.form, inputMode: this.inputmode, max: this.max, maxLength: this.maxlength, min: this.min, minLength: this.minlength, name: this.name, pattern: this.pattern, placeholder: this.placeholder, ref: (inputElem) => (this.inputElem = inputElem), readOnly: this.readonly, required: this.required, step: this.step, type: this.type, value: this.value, part: "input",
            // Events
        ...
        index.h("bq-button", { key: 'e566fc4a539773e7b90606960f603c37ba9a7dbf', class: "bq-input--control__clear ms-[--bq-input--gap] hidden", appearance: "text", "aria-label": this.clearButtonLabel, size: "small", onBqClick: this.handleClearClick, part: "clear-btn", exportparts: "button" }, index.h("slot", { key: '2fb6f3be2d29d8b0fcb7ce05b8031b2820922e15', name: "clear-icon" }, index.h("bq-icon", { key: 'd7988ae465c576497eb9c79fa050a9d1a61c372b', name: "x-circle", class: "flex" })))), index.h("span", { key: '70695ce87e7e2cd25842f55e646e3d6b0542e65a', class: { 'bq-input--control__suffix': true, '!hidden': !this.hasSuffix }, ref: (spanElem) => (this.suffixElem = spanElem), part: "suffix" }, index.h("slot", { key: '4de2dae0b8418d4e2002d546e322e95d928df2f4', name: "suffix", onSlotchange: this.handleSuffixSlotChange }))), index.h("div", { key: 'dac42dd887d753fe3ba90fc64548dcb4f37b5836', class: {
                [`bq-input--helper-text validation-${this.validationStatus}`]: true,
                '!hidden': !this.hasHelperText,
            }, ref: (divElem) => (this.helperTextElem = divElem), part: "helper-text" }, index.h("slot", { key: '933d7f6c2162f68c0efa45340b032da8fbfcb4bd', name: "helper-text", onSlotchange: this.handleHelperTextSlotChange }))));
    }
...
BqInput.style = BqInputStyle0;

exports.bq_input = BqInput;

//# sourceMappingURL=bq-input.cjs.entry.js.map