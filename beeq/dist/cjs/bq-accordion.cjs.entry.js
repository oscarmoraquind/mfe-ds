...
const BqAccordionStyle0 = bqAccordionCss;
...
const BqAccordion = class {
    ...
    // =======================
    checkPropValues() {
        props.validatePropValue(ACCORDION_SIZE, 'medium', this.el, 'size');
        props.validatePropValue(ACCORDION_APPEARANCE, 'filled', this.el, 'appearance');
    }
    ...
    handlePrefixSlotChange = () => {
        this.hasPrefix = slot.hasSlotContent(this.prefixElem, 'prefix');
    };
    handleSuffixSlotChange = () => {
        this.hasSuffix = slot.hasSlotContent(this.suffixElem, 'suffix');
    };
    get open() {
...
BqAccordion.style = BqAccordionStyle0;
