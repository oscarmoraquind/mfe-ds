...
const BqSlider = class {
    ...
    handleGapChange(newValue) {
        ...
        const value = !isNil.isNil(this.min) && !isNil.isNil(this.max) ? [this.min, this.max] : this.stringToObject(this.value);
    ...
    setState = (newValue) => {
        ...
        this.minValue = isRangeType ? clamp.clamp(value[0], this.min, this.max - this.gap) : value;
        this.maxValue = isRangeType ? clamp.clamp(value[1], this.minValue + this.gap, this.max) : this.minValue;
    };
    setThumbPosition = () => {
    ...
    stringToObject = (value) => (isString.isString(value) ? JSON.parse(value) : value);
    ...
    emitBqChange = () => {
        ...
        this.debounceBqChange = debounce.debounce(() => this.bqChange.emit({ value, el: this.el }), this.debounceTime);
