...
const BqTextarea = class {
    ...
    handleChange = (ev) => {
        if (this.disabled)
            return;
        if (!index$1.isHTMLElement(ev.target, 'textarea'))
            return;
...
BqTextarea.style = bqTextareaCss;

exports.bq_textarea = BqTextarea;

//# sourceMappingURL=bq-textarea.cjs.entry.js.map