...
const bqTab_types = require('./bq-tab.types-a8b320b0.js');
...
const BqTabGroup = class {
    ...
    checkPropValues() {
        index$1.validatePropValue(bqTab_types.TAB_SIZE, 'medium', this.el, 'size');
        index$1.validatePropValue(bqTab_types.TAB_ORIENTATION, 'horizontal', this.el, 'orientation');
        index$1.validatePropValue(bqTab_types.TAB_PLACEMENT, 'start', this.el, 'placement');
        this.bqTabElements.forEach((bqTabElement) => {
            ...
            bqTabElement.active = !index$1.isNil(this.value) ? bqTabElement.tabId === this.value : false;
        });
    }
    // Events section
    ...
    onKeyUp(event) {
        const { target } = event;
        if (!index$1.isHTMLElement(target, 'bq-tab'))
            return;
    ...
    focusTabSibling = async (currentTarget, direction) => {
        ...
        this.bqTabElements.forEach((bqTabElement, index, elements) => {
            ...
            if (bqTabElement === currentTarget) {
                target = index$1.getNextElement(elements, index, direction);
            }
        });
        if (target) {
            await target.vFocus();
    ...
    // ===================================
    render() {
        return (index.h(index.Host, { key: 'd9a0a66efe6184e314a1a34905463c2884704c70', class: { 'inline-block': this.orientation === 'vertical' } }, index.h("div", { key: '5b83f1843322861cf8a3916fd3d40a8d0954e4c6', class: {
                [`bq-tab-group bq-tab-group--${this.orientation}-${this.placement} flex is-full`]: true,
                'no-divider': this.disableDivider,
            }, part: "base" }, index.h("div", { key: '818859120417fe54104893d18c084f409e6770e1', class: {
                'bq-tab-group--container flex overflow-x-auto': true,
                'flex-col': this.orientation !== 'horizontal',
            }, role: "tablist", part: "tabs" }, index.h("slot", { key: 'c5b78305a7f9645c4c806cdf6cc63a3d48e34236' })))));
    }
...
BqTabGroup.style = bqTabGroupCss;

exports.bq_tab_group = BqTabGroup;

//# sourceMappingURL=bq-tab-group.cjs.entry.js.map