...
const BqToastStyle0 = bqToastCss;

const TOAST_PORTAL_SELECTOR = 'bq-toast-portal';
const BqToast = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.bqHide = index.createEvent(this, "bqHide", 7);
        this.bqShow = index.createEvent(this, "bqShow", 7);
    }
    // Own Properties
    // ====================
    autoDismissDebounce;
    ...
    // =======================================
    toastPortal = isClient.isClient() ? document.querySelector(`.${TOAST_PORTAL_SELECTOR}`) : null;
    // Public Property API
    // ========================
    ...
    // =======================
    checkPropValues() {
        props.validatePropValue(TOAST_TYPE, 'default', this.el, 'type');
        props.validatePropValue(TOAST_PLACEMENT, 'bottom-center', this.el, 'placement');
    ...
    handleTimeChange() {
        ...
        this.autoDismissDebounce = debounce.debounce(() => {
            this.hide();
        }, this.time);
    }
    handleOpenChange() {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f7a611330df56aa070f87d80974d010233b47528', style: style, class: { 'is-hidden': !this.open }, "aria-hidden": !this.open ? 'true' : 'false', hidden: !this.open ? 'true' : 'false', role: "status" }, index.h("output", { key: '92fe0a77c1dc3e8fdf0cc2776ff7da7db4beb298', class: "bq-toast", part: "wrapper" }, index.h("div", { key: '3354198b0aca7d13bce77c1bbeed798eac8ae228', class: { [`bq-toast--icon ${this.type}`]: true, '!hidden': this.hideIcon }, part: "icon" }, index.h("slot", { key: 'c9c4ef34dadc4da02a0a969b87c493f65207ce6f', name: "icon" }, index.h("bq-icon", { key: '05d0a5f46f1ca3d844698a746619500fc939423b', name: this.iconName, size: "24", slot: "icon", exportparts: "base,svg" }))), index.h("slot", { key: '41e7f87c3ede17b83e7b19bab1af5d2740bc5332' }))));
    }
...
BqToast.style = BqToastStyle0;

exports.bq_toast = BqToast;

//# sourceMappingURL=bq-toast.cjs.entry.js.map