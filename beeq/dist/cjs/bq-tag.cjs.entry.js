...
const BqTag = class {
    ...
    // =======================
    checkPropValues() {
        index$1.validatePropValue(TAG_SIZE, 'medium', this.el, 'size');
        index$1.validatePropValue(TAG_VARIANT, 'filled', this.el, 'variant');
    }
    // Events section
    ...
    render() {
        const style = {
            ...
            ...(this.color && { '--bq-tag--background-color': index$1.getColorCSSVariable(this.color) ?? this.color }),
            ...(this.hasCustomColor && { '--bq-text--primary': `var(--bq-text--alt)` }),
        };
        return (index.h(index.Host, { key: '4a787e7979e8d1db7d218fc474adccdc48762a69', style: style, "aria-hidden": this.isHidden ? 'true' : 'false', hidden: this.isHidden ? 'true' : 'false' }, index.h("button", { key: '9c98c9a8c1b451671f4a81103b4cfcf6977ef70f', class: {
            ...
            }, disabled: this.disabled, onBlur: this.handleBlur, onClick: this.handleClick, onFocus: this.handleFocus, tabindex: this.isClickable ? 0 : -1, part: "wrapper" }, index.h("span", { key: 'fd4c81e07f292978829fe691c9c36d1795a87ce1', class: { 'bq-tag__prefix inline-flex': true, '!hidden': !this.hasPrefix }, ref: (spanElem) => (this.prefixElem = spanElem), part: "prefix" }, index.h("slot", { key: 'a024873f42c89a4d2e15038a9538477d7d6841d1', name: "prefix", onSlotchange: this.handleSlotChange })), index.h("div", { key: '937bd63b6747891af06e0142b1054c4240baac81', class: {
                'text-xs': this.size === 'xsmall',
                'text-s': this.size === 'small',
                'text-m': this.size === 'medium',
            }, part: "text" }, index.h("slot", { key: 'a61c9db842414f1de0f473b0c363740841f16044' })), this.isRemovable && !this.disabled && (index.h("bq-button", { key: '6ae30878eecf43e1599b8296be3bc0c6127feb77', class: "bq-tag__close", appearance: "text", size: "small", onClick: this.handleHide, part: "btn-close" }, index.h("bq-icon", { key: '3251178f44079ad97547542a4b0d3b3d44034cb6', size: iconSize(this.size), name: "x-circle", color: this.color && !this.hasCustomColor ? textColor(this.color)[this.variant] : 'text--primary' }))))));
    }
...
exports.bq_tag = BqTag;

//# sourceMappingURL=bq-tag.cjs.entry.js.map