...
const BqDrawer = class {
    ...
    handlePlacementChange() {
        if (!index$1.isNil(this.placement)) {
        ...
        index$1.validatePropValue(DRAWER_PLACEMENT, 'right', this.el, 'placement');
    ...
    handlePositionChange() {
        index$1.validatePropValue(DRAWER_POSITIONS, 'start', this.el, 'position');
        /**
    ...
    handleFooterSlotChange = () => {
        this.hasFooter = index$1.hasSlotContent(this.footerElem, 'footer');
    };
    handleAfterHide = async () => {
        if (!this.drawerElem)
            return;
        await index$1.leave(this.drawerElem);
    ...
    handleAfterShow = async () => {
        ...
        await index$1.enter(this.drawerElem);
        this.handleTransitionEnd();
    };
    handleTransitionEnd = () => {
        if (this.open) {
    ...
    // ===================================
    render() {
        return (index.h(index.Host, { key: '645d443af186232f712d86c483b1c56de3fb34a5' }, this.enableBackdrop && (index.h("div", { key: 'd32abd3db021d4b222d674204fb2b6c8e364a430', class: {
            ...
            }, tabIndex: -1, part: "backdrop" })), index.h("div", { key: 'e412f591d4a6d5596058e61df70522f9517abef7', class: {
            ...
            }, ref: (div) => (this.drawerElem = div), "aria-hidden": !this.open ? 'true' : 'false', "aria-labelledby": "bq-drawer__title", "aria-modal": "true", hidden: !this.open, part: "panel", role: "dialog" }, index.h("header", { key: 'c272a91c5bb30456c628612374e55201d80a5ada', class: "flex items-center", part: "header" }, index.h("h2", { key: 'eeed6fb535afbe1f77d8c8751c16389a8969db5a', class: "flex-1 items-center justify-between font-bold leading-regular text-primary", id: "bq-drawer__title", part: "title" }, index.h("slot", { key: 'd2d264225b7a4fc8cf2666add42f49dab9afa610', name: "title" })), index.h("div", { key: '1e9230701c5e60473335594e64d45795f034c7c8', class: "flex", part: "button-close" }, index.h("bq-button", { key: 'bcb40fcf65774bc50fb710250e10b36a59b87e85', class: "[&::part(button)]:rounded-s [&::part(button)]:border-0 [&::part(button)]:bs-fit [&::part(button)]:p-b-0 [&::part(button)]:p-i-0 [&::part(label)]:inline-flex", appearance: "text", size: "small", slot: "button-close", exportparts: "button:button-close__btn,label:button-close__label", onClick: this.hide.bind(this) }, index.h("slot", { key: '71c62640a9a2ded728da262ff21eb3231c093446', name: "button-close" }, index.h("bq-icon", { key: '8ecbaa03cefbc36af5b62928b027998670223e91', name: "x-bold", role: "img", title: "Close" }))))), index.h("main", { key: '91e7f56b48301b89fc038781aa16ffdea469d4aa', class: "block flex-auto overflow-auto", part: "body" }, index.h("slot", { key: 'f8a9c484014473d163fce51842f42a6192df73e3' })), index.h("footer", { key: '767cd0c70930555b0a063d62e14a35c1bb728136', class: {
                block: true,
                '!hidden': !this.hasFooter,
            }, ref: (footerElem) => (this.footerElem = footerElem), part: "footer" }, index.h("slot", { key: 'f2f45af2ffb77d16ad4f2527571bc86047de4530', name: "footer-divider" }, index.h("bq-divider", { key: '70bff4d1228168e238e0af78cbd51a26b982fbde', class: "mb-m block", dashed: true })), index.h("slot", { key: 'ca1e7cf7be41185a31ce124097bdaa3556c537cc', name: "footer", onSlotchange: this.handleFooterSlotChange })))));
    }
...
BqDrawer.style = bqDrawerCss;

exports.bq_drawer = BqDrawer;

//# sourceMappingURL=bq-drawer.cjs.entry.js.map