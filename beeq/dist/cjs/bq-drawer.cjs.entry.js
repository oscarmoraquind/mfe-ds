...
const BqDrawer = class {
    ...
    handlePlacementChange() {
        ...
        props.validatePropValue(DRAWER_PLACEMENT, 'right', this.el, 'placement');
    ...
    handlePositionChange() {
        props.validatePropValue(DRAWER_POSITIONS, 'start', this.el, 'position');
        /**
    ...
    handleAfterHide = async () => {
        if (!this.drawerElem)
            return;
        await transition.leave(this.drawerElem);
    ...
    handleAfterShow = async () => {
        ...
        await transition.enter(this.drawerElem);
        this.handleTransitionEnd();
    };
    handleTransitionEnd = () => {
        if (this.open) {
