...
const BqIcon = class {
    constructor(hostRef) {
        ...
        this.svgLoaded = index.createEvent(this, "svgLoaded", 7);
    }
    // Own Properties
    // ====================
    ...
    handleWeightChange() {
       ...
       For example, '<bq-icon name="bell-fill"></bq-icon>' instead of '<bq-icon name="bell" weight="fill"></bq-icon>'`);
        ...
        const isWeightedIcon = !isNil.isNil(this.weight) && this.weight !== REGULAR;
